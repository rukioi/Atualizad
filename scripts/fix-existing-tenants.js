...
async function createSchemaForTenant(tenant) {
  const schemaName = tenant.schemaName;
  
  console.log(`Creating schema: ${schemaName} for tenant: ${tenant.name}`);
...
async function fixExistingTenants() {
  try {
    console.log('🔧 Fixing schemas for existing tenants...');
    ...
    for (const tenant of tenants) {
      ...
      await createSchemaForTenant(tenant);
    }
...
module.exports = { fixExistingTenants, createSchemaForTenant };
